    ...
    function() {
        ...
        function m(e, t, i, n, r, s) {
            var o = g.pop(),
                ...
                l = h.dotProduct(r);
            if (v(i, r, o), v(n, r, a), a[0] += l, a[1] += l, o[0] > a[1] || a[0] > o[1]) return C.push(h), g.push(o), g.push(a), !0;
            if (s) {
                var d = 0;
                if (o[0] < a[0])
        ...
        me.collision = ((f = {
            ...
            for (var s = C.pop().copy(i.pos).add(i.ancestor._absPos).add(n.pos).sub(e.pos).add(e.ancestor._absPos).sub(t.pos), o = n.radius, a = o * o, h = t.points, l = t.edges, d = l.length, c = C.pop(), u = C.pop(), f = C.pop(), m = 0, p = 0; p < d; p++) {
                ...
                if (w === E) {
                    var _ = null;
                    if (1 < d && (c.copy(l[v]), (w = S(c, _ = C.pop().copy(s).sub(h[v]))) !== A && (b = !1)), b) {
                        if (o < (m = f.length())) return C.push(s), C.push(c), C.push(u), C.push(f), _ && C.push(_), !1;
                        r && (r.bInA = !1, x = f.normalize(), y = o - m)
                    }
                    _ && C.push(_)
                } else if (w === A) {
                    ...
                    r && (x = u, y = o - m, (0 <= m || y < 2 * o) && (r.bInA = !1))
                }
                x && r && Math.abs(y) < Math.abs(r.overlap) && (r.overlap = y, r.overlapN.copy(x))
            }
    ...
    function() {
        ...
        me.BitmapFont = me.Renderable.extend({
            ...
            measureText: function(e) {
                for (var t = ("" + e).split("\n"), i = 0, n = 0, r = this.bitmapFontData.capHeight * this.lineHeight, s = 0; s < t.length; s++) i = Math.max(v(this, t[s]), i), n += r;
                return {
                    width: i,
        ...
        parse: function(e) {
            ...
            for (a = 0; a < this.capChars.length; a++) {
                var y = this.capChars[a];
                if (v = this.glyphs[y.charCodeAt(0)]) break
            }
            if (v) this.capHeight = v.height;
            else
    ...
    function() {
        ...
        me.video = (v = g = (f = 1) / (p = m = u = 0), y = {
            ...
            var n, r = (m = e) * me.sys.scale.x,
                s = t * me.sys.scale.y;
            if (y.zoomX = r, y.zoomY = s, window.addEventListener("resize", me.utils.function.throttle(function(e) {
            ...
            switch (y.renderer) {
                ...
                case c.WEBGL:
                    ...
                    break;
                default:
                    this.renderer = new me.CanvasRenderer(n, e, t, y)
            }
            ...
            g = e || 1 / 0, v = t || 1 / 0, me.utils.function.defer(me.video.onresize, me.video)
            ...
            var e = 1,
                t = 1;
            if (c._canvasOffset = null, y.autoScale) {
                var i, n, r = me.video.renderer.getScreenCanvas().parentNode;
                if (void 0 !== r)
                    if (y.useParentDOMSize && "function" == typeof r.getBoundingClientRect) {
                        var s = r.getBoundingClientRect();
                        i = s.width || s.right - s.left, n = s.height || s.bottom - s.top
                    } else i = r.width, n = r.height;
                var o = Math.min(g, i || window.innerWidth),
                    a = Math.min(v, n || window.innerHeight),
                    h = o / a,
                    l = 1 / 0,
                    d = 1 / 0;
                "fill-min" === y.scaleMethod && f < h || "fill-max" === y.scaleMethod && h < f || "flex-width" === y.scaleMethod ? (e = t = o / (l = Math.min(g, p * h)), l = ~~(l + .5), this.renderer.resize(l, p), me.game.viewport.resize(l, p), me.game.world.updateChildBounds()) : "fill-min" === y.scaleMethod && h < f || "fill-max" === y.scaleMethod && f < h || "flex-height" === y.scaleMethod ? (e = t = a / (d = Math.min(v, m * (a / o))), d = ~~(d + .5), this.renderer.resize(m, d), me.game.viewport.resize(m, d), me.game.world.updateChildBounds()) : "flex" === y.scaleMethod ? (this.renderer.resize(o, a), me.game.viewport.resize(o, a), me.game.world.updateChildBounds()) : "stretch" === y.scaleMethod ? (e = o / m, t = a / p) : e = t = h < f ? o / m : a / p, e *= me.device.devicePixelRatio, t *= me.device.devicePixelRatio, u && clearTimeout(u), u = me.utils.function.defer(me.video.updateDisplaySize, this, e, t)
            }
    ...
    function(p) {
        ...
        function u(e) {
            for (var t = !1; 0 < e.length;) {
                ...
                y.setShape(i.gameWorldX, i.gameWorldY, i.width, i.height);
                for (var n, r = me.collision.quadTree.retrieve(y, me.Container.prototype._sortReverseZ), s = (r = r.concat([me.game.viewport])).length; n = r[--s];) {
                    if (v.has(n) && !0 !== n.isKinematic) {
                        var o = v.get(n),
                            a = o.region,
                            h = a.ancestor,
                            l = a.getBounds(),
        ...
        p.pointer = new me.Pointer(0, 0, 1, 1), p.pointer.bind = [0, 0, 0], p.pointer.LEFT = 0, p.pointer.MIDDLE = 1, p.pointer.RIGHT = 2, p.throttlingInterval = void 0, p.globalToLocal = function(e, t, i) {
            ...
            for (var r = v.get(t), s = 0; s < n.length; s++) e = n[s], r.callbacks[e] ? r.callbacks[e].push(i) : r.callbacks[e] = [i]
            ...
            if (void 0 !== r) {
                ...
                0 === Object.keys(r.callbacks).length && v.delete(t)
            }
    ...
    function() {
        ...
        me.Tween = function(e) {
            ...
            this.isRenderable = !1, this._resumeCallback = function(e) {
                ...
                for (var t in d = e, c = {}, u = {}, f = {}, v = g = !(m = 1e3), y = p = 0, x = null, w = me.Tween.Easing.Linear.None, b = me.Tween.Interpolation.Linear, E = !(_ = []), C = A = T = null, S = me.timer.lastUpdate, this.isPersistent = !1, this.updateWhenPaused = !1, e) "object" != typeof e && (c[t] = parseFloat(e[t], 10))
                ...
                for (var t in E = !1, me.game.world.addChild(this), x = (void 0 === e ? me.timer.getTime() : e) + y, u) {
...
game.PlayerEntity = me.Entity.extend({
    ...
    init: function(e, t, i) {
        ...
        var n = i.width;
        i.height;
        i.framewidth = i.width = 50, i.frameheight = i.height = 60, i.shapes[0] = new me.Rect(0, 0, i.framewidth, i.frameheight), me.Entity.prototype.init.apply(this, [e, t, i]), e = this.pos.x, this.startX = e, this.endX = e + n - i.framewidth, this.pos.x = e + n - i.framewidth, this.walkLeft = i.directionright, this.body.setVelocity(.7, 6)
    },
    update: function(e) {
