...
var game = {
    ...
    resources: [{
        ...
        type: "image",
        src: "data/img/map/0x72_16x16RobotTileset.v1.png"
    }, {
...
game.PlayerEntity = me.Entity.extend({
    ...
    init: function(e, t, i) {
        ...
        var n = i.width;
        i.height;
        i.framewidth = i.width = 50, i.frameheight = i.height = 60, i.shapes[0] = new me.Rect(0, 0, i.framewidth, i.frameheight), me.Entity.prototype.init.apply(this, [e, t, i]), e = this.pos.x, this.startX = e, this.endX = e + n - i.framewidth, this.pos.x = e + n - i.framewidth, this.walkLeft = i.directionright, this.body.setVelocity(.5, 6)
    },
    update: function(e) {
